...
| `700` | `WerewolfRoom` | `dataSet`、`counterMap` | 投票状態・結果更新 |
...
- `frontend/src/features/werewolf/reducer.test.ts` で status `100/101/150/300/400/500/550/600/650/700/998/999`、ローカル action を検証。
- 手動確認は3人以上の複数タブで、役職設定、開始、役職選択、議論アクション、時間切れ、投票、結果、チャット、アイコン変更を確認する。
